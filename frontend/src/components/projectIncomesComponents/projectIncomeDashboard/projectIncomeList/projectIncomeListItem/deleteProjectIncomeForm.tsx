...
interface DeleteProjectIncomeFormProps {
	income: ProjectIncome;
	deleteIncome: (id: string) => void;
	close: () => void;
}

const DeleteProjectIncomeForm: FC<DeleteProjectIncomeFormProps> = ({ income, deleteIncome, close }) => {
	...
	return (
		<div className="p-4">
			<div>
				<h2 className="text-xl font-bold mb-4">Deleting Project Income</h2>
			</div>
			<div>
				<p>Are you sure?</p>
			</div>
...
export default DeleteProjectIncomeForm;
