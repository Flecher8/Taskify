...
const NotificationsDashboard: FC<NotificationsDashboardProps> = () => {
	...
	return (
		<div className="flex flex-col w-full h-96">
			<div className="w-full h-8 pb-8 border-b border-violet-900 p-3 flex flex-row justify-between items-center">
				<div>
			...
			<div className="w-full pt-3 overflow-auto notificationList">
